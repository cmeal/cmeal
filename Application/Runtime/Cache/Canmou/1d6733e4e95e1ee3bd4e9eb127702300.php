    ...
    <div class="main-content">
        <div class="page-content">
            <div class="page-content-area">
                <div class="row">
                    <div class="col-xs-12">
                        <h3 class="header smaller lighter blue">广告列表</h3>
                        <?php
		...
		<i class="ace-icon fa fa-times"></i>
                        ...
                        <div>
                            <div id="sample-table-2_wrapper" class="dataTables_wrapper form-inline no-footer">
                                <div class="row">
                                    <div class="col-xs-6">
                                        <a href="/canmou/ad/add">
                                            <button class="btn btn-info">添加广告</button>
                                        </a>
                                    </div>
                                    <div class="col-xs-6">
                                    </div>
                                ...
                                <table id="sample-table-2" class="table table-striped table-bordered table-hover dataTable no-footer">
                                    ...
                                    <tbody>
                                    <?php if(is_array($ads)): $i = 0; $__LIST__ = $ads;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ad): $mod = ($i % 2 );++$i;?><tr role="row" class="even">
                                            <td class="center">
                                                <label class="position-relative">
                                                    <input type="checkbox" class="ace">
                                                    <span class="lbl"></span>
                                            ...
                                            <td><?php echo ((isset($ad['type']) && ($ad['type'] !== ""))?($ad['type']):"首页广告"); ?></td>
                                            <td><?php echo (date("Y-m-d H:m:s",$ad['created'])); ?></td>
                                            <td>
                                                <?php if($ad['status'] == 1): ?><span class="label label-sm label-info">启用</span>
                                                    <?php else: ?>
                                                    <span class="label label-sm label-warning">禁用</span><?php endif; ?>
                                            </td>
                                            <td>
                                                <div class="hidden-sm hidden-xs action-buttons">
                                                    <a class="green" href="/canmou/ad/edit?id=<?php echo ($ad['aid']); ?>" >
                                                        <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                    </a>
                                                    <!--delete action-->
                                                    <a class="green" href="/canmou/ad/delete?id=<?php echo ($ad['aid']); ?>" >
